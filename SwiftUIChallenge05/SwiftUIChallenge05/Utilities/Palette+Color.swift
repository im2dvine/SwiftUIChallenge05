...
extension Color {
    ...
    static let baseLineColor = Color("baseLineColor")
    static let baseSubtotalLines = Color("baseSubtotalLines")
}
...
extension UIColor {
    ...
    static let baseLineColor = Color(named: "baseLineColor")
    static let baseSubtotalLines = Color(named: "baseSubtotalLines")
